...
- `.claude/rules/package.md` — 패키지 생성 전체 절차
...
상세: [testing.md](../rules/testing.md)

### Javadoc & Checkstyle

모든 public 메서드에 한글 명사형 Javadoc 필수. Google Java Style(2칸 들여쓰기).
상세: [commenting.md](../rules/commenting.md)
