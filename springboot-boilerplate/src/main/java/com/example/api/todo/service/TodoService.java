...
public class TodoService {
  ...
  private Counter todoCreateCounter;

  @PostConstruct
  void initMetrics() {
    todoCreateCounter = Counter.builder("todo.create.count")
        .description("Todo 생성 횟수")
   ...
   * @return 페이지 응답
   */
  @Cacheable(value = "todo:list", key = "#email")
   ...
   * @return 생성된 할 일
   */
  @CacheEvict(value = "todo:list", key = "#email")
  @Transactional
